...
![版本](https://img.shields.io/badge/version-v0.3.3-2ea44f)
...
v0.2.2 可靠指令闭环与 v0.2.3 安全配对已完成受控验证，v0.3.0 已落地单一黄金工作流，v0.3.3 已完成桌面控制台与高刷新率悬浮菜单体验修复。当前继续用真实使用数据验证这套工作流，不扩展第二个场景。
